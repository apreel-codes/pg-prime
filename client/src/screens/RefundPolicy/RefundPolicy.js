...
const RefundPolicy = () => {
    return (
        <div className="refund">
            <div className="w-[85%] md:w-[80%] mx-auto my-24">
                ...
                <div className="mt-5">
                    ...
                    <p className="mt-5">If you have any questions or need further assistance, please don't hesitate to contact our dedicated customer support team. 
