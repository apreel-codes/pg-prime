...
const Header = () => {
  ...
  const profile = <img src='../images/user.png'/>
    ...
    return (
            <header className=''>
                <div className='top-nav flex flex-row justify-between items-center py-2 pl-6 md:px-20 md:py-2'>
                    ...
                    <div className='flex flex-row justify-between gallery-refund'>
                        <Link className='hidden md:block'>Gallery</Link>
                        <Link className='' to='/refundpolicy'>Refund Policy</Link>
                    </div>
                </div>
                <div className='web-second md:flex md:flex-row md:justify-between items-center py-2 pl-16 md:px-20 md:py-2 hidden md:block'>
                    <Link to='/'><img src='../images/nav-logo.png'/></Link>
